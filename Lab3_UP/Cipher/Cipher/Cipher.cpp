...
// Cipher.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCipherApp, CWinApp)
...
// Единственный объект CCipherApp

CCipherApp theApp;


// Инициализация CCipherApp

BOOL CCipherApp::InitInstance()
{
